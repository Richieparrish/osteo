...
export type PromptInputFileTriggerProps = ComponentProps<typeof Button>;

export const PromptInputFileTrigger = ({
  children,
  onClick,
  ...props
...
export const PromptInput = ({
  ...
  const submitForm = useCallback(
    ...
    [files, usingProvider, controller, onSubmit, clear]
  );
